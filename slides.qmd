...
We were invited to write an article on **Cross-Lagged Panel Models** (CLPM) for the *Journal of Developmental and Life Course Criminology*
...
Time is continuous anyway; missing data are *infinite*^[Discrete data work in continuous time differential equations though]
